    ...
    getAllCampaignsFromAdOpsTeam(advertiserId, adOpsTeamId) {
        ...
        return this._objectStore
            ...
            campaignsDocuments.docs.map((campaignDocument) => {
                campaigns.push(new Campaign_1.Campaign(campaignDocument.get('name'), campaignDocument.get('advertiser'), campaignDocument.get('adOpsTeam'), campaignDocument.get('campaignId'), campaignDocument.get('active'), campaignDocument.get('created')));
            });
            return campaigns;
        })
            .catch((err) => {
