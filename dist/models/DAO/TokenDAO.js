        ...
        return this._token
            ...
            if (querySnapshot.size > 0) {
                ...
                querySnapshot.forEach((documentSnapshot) => {
                    ...
                    if (searchId) {
                        token = new Token_1.Token(searchId[0], documentSnapshot.get('permission'), documentSnapshot.get('advertiser'), documentSnapshot.get('email'), documentSnapshot.get('active'), documentSnapshot.get('adOpsTeam'));
                    }
                    else {
