...
class GA extends AnalyticsTool_1.AnalyticsTool {
    ...
    buildedLine() {
        ...
        return {
            values: Object.assign(Object.assign({}, utmReturn), { 'url ga': this._hasAnyErrorAtUtms() ? 'Corrija os parâmetros para gerar a URL' : this.url }),
            hasError: hasError,
        };
    }
    _buildUtms() {
        ...
        Object.keys(this.config.analyticsTool.ga).forEach((utm) => {
            ...
            utms[utm] = StringUtils_1.StringUtils.replaceWhiteSpace(StringUtils_1.StringUtils.normalize(utmString).slice(0, -1), this.config.spaceSeparator);
        });
        return utms;
    }
    _buildUrl() {
