        ...
        if (querySnapshot.size > 0) {
            ...
            querySnapshot.forEach((documentSnapshot) => {
                ...
                if (searchId) {
                    ...
                    user = new User_1.User(searchId[0], documentSnapshot.get('permission'), documentSnapshot.get('company'), documentSnapshot.get('email'), documentSnapshot.get('activate'), documentSnapshot.get('agency'));
                }
                else {
                    throw new Error('Nenhum usuário encontrado!');
                }
