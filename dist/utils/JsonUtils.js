...
class JsonUtils {
    ...
    static normalizeKeys(json) {
        ...
        Object.keys(json).map((key) => {
            jsonNormalized[StringUtils_1.StringUtils.normalize(key)] = json[key];
            if (this._keyValueIsAnObject(jsonNormalized[StringUtils_1.StringUtils.normalize(key)])) {
                jsonNormalized[StringUtils_1.StringUtils.normalize(key)] = this.normalizeKeys(jsonNormalized[StringUtils_1.StringUtils.normalize(key)]);
            }
        });
