...
const adOpsTeam = (app) => {
    app.post('/adOpsTeam', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        new AdOpsTeamDAO_1.AdOpsTeamDAO()
            ...
            .then((status) => {
            if (status)
                apiResponse.responseText = 'AdOpsTeam criado com sucesso!';
            else
                throw new Error('Erro ao criar o AdopsTeam!');
        })
            .catch((err) => {
    ...
    app.get('/adOpsTeam', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = new ApiResponse_1.ApiResponse();
    ...
    app.get('/adOpsTeam/list', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        new AdOpsTeamDAO_1.AdOpsTeamDAO()
            ...
            const adOpsTeamsToReturn = permission !== 'owner' && permission !== 'admin'
    ...
    app.get('/adOpsTeam/:adOpsTeam/users', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = new ApiResponse_1.ApiResponse();
        const advertiser = req.advertiser;
    ...
    app.get('/adOpsTeam/campaigns', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = new ApiResponse_1.ApiResponse();
        const advertiser = req.advertiser;
        const adOpsTeam = req.adOpsTeam;
    ...
    app.get('/adOpsTeam/:adOpsTeam/campaigns', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = new ApiResponse_1.ApiResponse();
        const advertiser = req.advertiser;
        const adOpsTeam = req.params.adOpsTeam;
        new CampaignDAO_1.CampaignDAO()
