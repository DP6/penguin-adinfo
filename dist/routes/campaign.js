...
const campaign = (app) => {
    ...
    app.get('/agencies/campaigns', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var e_1, _a;
        const apiResponse = new ApiResponse_1.ApiResponse();
        const company = req.company;
        const agency = req.agency;
        const permission = req.permission;
        const gettingAgencies = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (permission === 'admin' || permission === ' owner')
            allAgencies.push('Campanhas Internas');
        const agenciesToReturn = [];
        try {
            for (var allAgencies_1 = __asyncValues(allAgencies), allAgencies_1_1; allAgencies_1_1 = yield allAgencies_1.next(), !allAgencies_1_1.done;) {
    ...
    app.get('/campaign/:agency/list', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = new ApiResponse_1.ApiResponse();
    ...
    app.get('/:agency/:campaignId/csv/list', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const apiResponse = new ApiResponse_1.ApiResponse();
