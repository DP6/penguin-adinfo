    ...
    if (url === '/login') {
        ...
        try {
            if (token) {
                ...
                const token = new Token_1.Token(payloadTokenAccess.id, payloadTokenAccess.permission, payloadTokenAccess.advertiser, payloadTokenAccess.email, payloadTokenAccess.active, payloadTokenAccess.adOpsTeam);
